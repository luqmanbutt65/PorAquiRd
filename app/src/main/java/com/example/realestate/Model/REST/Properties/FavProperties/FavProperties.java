...
public class FavProperties extends RealmObject {
    ...
    public RealmList<FavProperties> getPropertiesExtraArrayList() {
        return propertiesExtraArrayList;
    }

    public void setPropertiesExtraArrayList(RealmList<FavProperties> propertiesExtraArrayList) {
        this.propertiesExtraArrayList = propertiesExtraArrayList;
    }

    public RealmList<FavProperties> getPropertiesGalleryArrayList() {
        return propertiesGalleryArrayList;
    }

    public void setPropertiesGalleryArrayList(RealmList<FavProperties> propertiesGalleryArrayList) {
