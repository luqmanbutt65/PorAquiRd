...
public class AboutUs extends Fragment {
    ImageView back_btn;
    ProgressDialog aboutusProgressdialog;
    TextView tv_heading;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        aboutusProgressdialog = new ProgressDialog(getContext());
        aboutusProgressdialog.setMessage("Loading ...");
        aboutusProgressdialog.setCancelable(false);

        tv_heading = view.findViewById(R.id.tv_aboutus);
        back_btn = view.findViewById(R.id.back_btn_abotus);
    ...
    public void getprivcypolicydata() {
        aboutusProgressdialog.show();
        String cookies_policy = "about_us";
