...
public class ConnectorProfileFragment_update extends Fragment {
    ...
    public ConnectorProfileFragment_update() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_connectorprofile_update, container, false);
...
//                intent.putExtra(Intent.EXTRA_TITLE, "invoice.pdf");
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (Name_Compantname.isEmpty() || ID.isEmpty() || cellno1.isEmpty()) {
